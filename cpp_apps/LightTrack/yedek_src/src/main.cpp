...
int main(int argc, char** argv)
{
    ...
    // Get model path.
    std::string init_model = "/home/firefly/Desktop/LightTrack/model2/track_backbone_T.rknn";
    std::string backbone_model = "/home/firefly/Desktop/LightTrack/model2/track_backbone_T.rknn";
    std::string neck_head_model = "/home/firefly/Desktop/LightTrack/model2/head.rknn";
