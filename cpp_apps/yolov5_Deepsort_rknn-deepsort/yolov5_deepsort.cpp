...
bool add_head = false;
string PROJECT_DIR = "/home/firefly/Desktop/yolov5_Deepsort_rknn-deepsort/";


string YOLO_MODEL_PATH = PROJECT_DIR + "/model/best.rknn";
string SORT_MODEL_PATH = PROJECT_DIR + "/model/osnet_x0_25_market.rknn";

string VIDEO_PATH = PROJECT_DIR + "/data/bilginer.mp4";
string VIDEO_SAVEPATH = PROJECT_DIR + "/data/cikti.mp4";
